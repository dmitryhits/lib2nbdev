# AUTOGENERATED! DO NOT EDIT! File to edit: ../01_generators.ipynb.

# %% auto 0
__all__ = ['generate_settings', 'generate_ci', 'generate_doc_foundations', 'generate_setup']

# %% ../01_generators.ipynb 3
from fastcore.xtras import Path
import requests

# %% ../01_generators.ipynb 4
